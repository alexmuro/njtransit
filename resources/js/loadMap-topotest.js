function loadCensusLayers()
{
    ...
    console.log('load Census Layers')
    
    url = "d3tests/us_counties.json";

     topo = new OpenLayers.Layer.Vector('TopoJSON', {
    eventListeners:{
    ...
    //topo.styleMap =  getMultiStyle();
    map.addLayer(topo);
    //topo.styleMap =  getMultiStyle();
    selectlayerer = new OpenLayers.Control.SelectFeature([topo],{
