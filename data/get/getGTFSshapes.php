...
trips.shape_id,
count(trips.route_id) as numTrips
FROM trips
where shape_id = ".$route."
group by route_id,shape_id";

$mrs=mysql_query($meta_sql) or die($meta_sql."<br><br>".mysql_error());
$meta = mysql_fetch_assoc( $mrs );
...
$sql = "select 
        ...
        FROM shapes where shapes.shape_id =".$route;
echo $meta['routeID'].",";
