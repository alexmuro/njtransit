...
var viz = {
  ...
  //   	.addLayer(new L.TileLayer("http://{s}.tile.cloudmade.com/117aaa97872a451db8e036485c9f464b/998/256/{z}/{x}/{y}.png"))
		...
		var tracts = function() {
			d3.json('../data/zones/2/ct.json', function(data) {
		...
		var routes = function() {
			...
			data = transitData.getGTFS(viz.zone);
		...
		// var stops = function() {
		// 	d3.json('index_files/sf-stops.json', function(data) {
    ...
    sanfrancisco : function() {
		...
		// functions to draw tracts, routes, and stops
		var tracts = function() {
			d3.json('index_files/sf-census.json', function(data) {
				group.selectAll("path.tract")
					.data(data.features)
					.enter()
					.append("path")
		...
		var routes = function() {
			d3.json('index_files/sf-routes.json', function(data) {
				group.selectAll("path.route")
					.data(data.features)
					.enter()
					.append("path")
